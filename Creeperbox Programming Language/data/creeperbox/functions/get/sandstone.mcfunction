...
execute as @s at @s if block ~ ~ ~ sandstone run data modify storage creeperbox:storage Stack append value {Value:1}

execute as @s at @s unless block ~ ~ ~ sandstone run data modify storage creeperbox:storage Stack append value {Value:0}
