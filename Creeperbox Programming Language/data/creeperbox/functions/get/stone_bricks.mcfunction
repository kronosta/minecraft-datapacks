...
execute as @s at @s if block ~ ~ ~ stone_bricks run data modify storage creeperbox:storage Stack append value {Value:1}

execute as @s at @s unless block ~ ~ ~ stone_bricks run data modify storage creeperbox:storage Stack append value {Value:0}
