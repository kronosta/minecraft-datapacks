...
execute as @s at @s if block ~ ~ ~ chiseled_stone_bricks run data modify storage creeperbox:storage Stack append value {Value:1}

execute as @s at @s unless block ~ ~ ~ chiseled_stone_bricks run data modify storage creeperbox:storage Stack append value {Value:0}
