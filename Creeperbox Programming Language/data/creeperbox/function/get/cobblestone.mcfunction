...
execute as @s at @s if block ~ ~ ~ cobblestone run data modify storage creeperbox:storage Stack append value {Value:1}

execute as @s at @s unless block ~ ~ ~ cobblestone run data modify storage creeperbox:storage Stack append value {Value:0}
