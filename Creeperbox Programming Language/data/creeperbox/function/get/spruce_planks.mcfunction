...
execute as @s at @s if block ~ ~ ~ spruce_planks run data modify storage creeperbox:storage Stack append value {Value:1}

execute as @s at @s unless block ~ ~ ~ spruce_planks run data modify storage creeperbox:storage Stack append value {Value:0}
